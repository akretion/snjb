...
class ProductSupplierinfo(models.Model):
    ...
    categ_margin = fields.Float(
        ...
        # related="product_tmpl_id.price_category_id.supplierinfo_margin",
    ...
    def _get_supplierinfo_pricelist_price(self):
        ...
        categ_margin = max(
            self.product_tmpl_id.categ_id.supplierinfo_margin,
            self.product_tmpl_id.price_category_id.supplierinfo_margin,
        )
        if categ_margin:
